...
class _ProfileWidgetState extends State<ProfileWidget> {
  ...
  void initState() {
    ...
    _model.nowaFocusNode ??= FocusNode();
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      8.0, 100.0, 8.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.nowaTextController ??=
                                        TextEditingController(
                                      text: valueOrDefault<String>(
                                        DashboardCall.userphone(
                                          stackDashboardResponse.jsonBody,
                                        ),
                                        'phone',
                                      ),
                                    ),
                                    focusNode: _model.nowaFocusNode,
                                    autofocus: true,
                                    readOnly: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
